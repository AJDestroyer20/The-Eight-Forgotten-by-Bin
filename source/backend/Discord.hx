...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1392990883984576552";
	...
	public static function changePresence(details:String = 'Iniciando el Mod', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'los8icon.gif')
	{
		...
		presence.largeImageText = 'Los 8 Olvidados por Bin: ${MainMenuState.pSliceVersion} (${MainMenuState.psychEngineVersion})';
