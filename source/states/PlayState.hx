...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['MANCO!', 0.2], //From 0% to 19%
		['Miercoles!', 0.4], //From 20% to 39%
		['MALISIMO', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Podrías mejorar', 0.69], //From 60% to 68%
		['wow', 0.7], //69%
		['OMG', 0.8], //From 70% to 79%
		['Igual de bueno que AJ', 0.9], //From 80% to 89%
		['A huevo', 1], //From 90% to 99%
		['LA CABRA', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
